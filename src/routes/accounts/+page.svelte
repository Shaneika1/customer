<section class="guest-order-section bg-center bg-no-repeat">
    <div class="px-4 mx-auto text-center pt-10 lg:py-16">
        ...
        >
            If you are paying by bank transfer, here is a list of our accounts. Please share a screenshot once payment is made. WhatsApp the transfer receipt to 8763382745, thanks in advance.
        </p>
